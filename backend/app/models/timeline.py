...
class TimelineEvent(BaseEntity, Base):
    ...
    event_type: Mapped[str] = mapped_column(
        String(50), nullable=False, server_default="custom", index=True
    )
    ...
    participants: Mapped[list["TimelineParticipant"]] = relationship(
        "TimelineParticipant", cascade="all, delete-orphan"
    )
