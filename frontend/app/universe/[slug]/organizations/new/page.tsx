        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-10">
          <EntityFormSection title="Basic Information">
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <Field label="Type">
                <input
                  className={inputCls}
                  placeholder="e.g. Guild, Military, Secret Society"
                  {...register("type")}
                />
              </Field>
              <Field label="Leader">
                <input
                  className={inputCls}
                  placeholder="Current leader or figurehead"
                  {...register("leader")}
                />
              </Field>
            </div>
          ...
          <EntityFormSection title="Purpose">
            <Field label="Purpose" error={errors.purpose?.message}>
              <textarea
                className={inputCls}
                rows={3}
                placeholder="Goals and mission of this organization..."
                {...register("purpose")}
              />
            </Field>
          </EntityFormSection>
          ...
          <div className="flex gap-3 border-t border-border pt-6">
            ...
            <Button
              type="button"
              variant="ghost"
              onClick={() => router.push(`/universe/${slug}/organizations`)}
            >
              Cancel
            </Button>
          </div>
